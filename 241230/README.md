...
|총 문제 수|티어|유형|
|---:|---|---|
|1|![Silver3][s3] ~ ![Silver3][s3]|`String` `TreeMap`|

|기록분류|이름|티어|유형|상태|최근 제출 코드|
|---|---|---|---|---|---|
|릴레이|[단어 사전](https://www.codetree.ai/training-field/search/problems/word-dict)|![Silver4][s4]|`TreeMap` `String`|![Passed][passed]|[링크](https://github.com/Rynf0rce/codetree-TILs/blob/main/241230/%EB%8B%A8%EC%96%B4%20%EC%82%AC%EC%A0%84/word-dict.java)|
