...
public class Main {
    ...
    public static final int NUM_DIRECTION = 8;

    public static int[][] table = new int[RAX_RANGE][RAX_RANGE];
    public static int[][] visited = new int[RAX_RANGE][RAX_RANGE];
    public static int[] arrRow = new int[]{-2, -1, 1, 2, 2, 1, -1, -2};
    public static int[] arrCol = new int[]{1, 2, 2, 1, -1, -2, -2, -1};
    ...
    public static boolean canGo(int row, int col){
        if(!inRange(row, col) || visited[row][col] > 0){
            return false;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.print(visited[r2][c2] == 0 ? -1 : visited[r2][c2] - 1);
